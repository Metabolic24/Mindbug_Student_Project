...
public class StartServiceTest extends MindbugGameTest{
    ...
    public void testStart_evolutionCards() {
        Game game = StartService.startGame(new Player(playerService.createPlayer("Player1")), new Player(playerService.createPlayer("Player2")), CardSetName.BEYOND_EVOLUTION);
