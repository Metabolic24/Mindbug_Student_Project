...
public enum EffectType {
    BOUNCE, COST, COPY, DESTROY, DISABLE_TIMING, DISCARD, DRAW, EVOLVE, FORCE_ATTACK, GAIN, GIVE,
    INFLICT, KEYWORD_UP, NO_ATTACK, NO_BLOCK, POWER_UP, PROTECTION, REVIVE, STEAL
